...
///     }
///   }
class ModelCompletionsResponse {
  final String? id;
  final String object;
  final int? created;
  final String? model;
  ...
  const ModelCompletionsResponse({
    required this.id,
  ...
  factory ModelCompletionsResponse.fromResponse(Response response) {
    ...
    return ModelCompletionsResponse(
